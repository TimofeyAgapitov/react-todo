...
function App() {
  ...
  const onAddListElement = (obj) => {
    const newList = [...lists, obj];

    setLists(newList);
  };
  const onAddTaskElement = (listId, taskObj) => {
  ...
  const onRemoveTaskElement = (listId, taskId) => {
  ...
  const onEditTaskElement = (listId, taskObj) => {
  ...
  return (
    <div className="todo">
      <div className="todo__sidebar">
          ...
          items={[
            {
              icon: (
                ...
                12.6ZM7.74001 5.40001H14.76C15.2568 5.40001 15.3 4.99771 15.3 4.50001C15.3 4.00231 15.2568 3.60001 
                14.76 3.60001H7.74001C7.24321 3.60001 7.20001 4.00231 7.20001 4.50001C7.20001 4.99771 7.24321 5.40001 
                7.74001 5.40001ZM4.86001 8.10001H3.24001C2.74321 8.10001 2.70001 8.50231 2.70001 9.00001C2.70001 9.49771 
                2.74321 9.90001 3.24001 9.90001H4.86001C5.35681 9.90001 5.40001 9.49771 5.40001 9.00001C5.40001 8.50231 
                5.35681 8.10001 4.86001 8.10001ZM4.86001 12.6H3.24001C2.74321 12.6 2.70001 13.0023 2.70001 13.5C2.70001 
        ...
        <AddButtonSidebar onAddListElement={onAddListElement} colors={colors} />
      </div>
      <div className="todo__tasks">
        {lists && activeItem && (
          <Tasks
            ...
            onRemoveTaskElement={onRemoveTaskElement}
            onEditTaskElement={onEditTaskElement}
          />
        )}
      </div>
    </div>
